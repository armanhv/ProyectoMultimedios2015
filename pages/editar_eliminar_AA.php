...
<!DOCTYPE HTML>
<head>
    <title>Editar Actividades/Atractivos</title>
...
<body>
    ...
    <div class="main">
        <div class="content">
            <div class="wrap">
                <h2>Editar Actividades o Atractivos Turisticos</h2>
                                ...
                                <div class="section group">
                                    <div class="col_1_of_4 span_1_of_4">                            
                                        <div class="services_list">
                                            <span ><input type="submit" value="Eliminar"  class="myButton" style="background: red; border-color: red">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                        </div>
                                    ...
                                    <div class="col_1_of_4 span_1_of_4">                           
                                        <div class="services_list">
                                            <span ><input type="submit" value="Actualizar" class="myButton"></span>
                                        </div>
                                    </div>                                               
                                </div>	          
                            </div>
